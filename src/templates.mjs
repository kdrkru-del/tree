...
function branchChippingUpsell() {
  return `<section class="section branch-upsell" id="izmeldenie"><div class="container"><div class="branch-upsell-inner"><div><p class="eyebrow">Дополнительная услуга</p><h2>Измельчение веток в щепу</h2><p>Измельчим ветки после спила, обрезки или расчистки участка. Дробилка (щепорез) существенно уменьшает объем древесных отходов.</p><p class="from-price-large">от 2 500 ₽</p><div class="branch-upsell-actions"><a class="btn btn-accent" href="/tree/izmeldenie-vetok/" data-goal="click_branch_chipping">Рассчитать стоимость измельчения</a><a class="link-more" href="/tree/izmeldenie-vetok/">Подробнее об услуге</a></div></div><div class="branch-upsell-options"><p><strong>Что делать с ветками после работы?</strong></p><ul><li>🌿 Оставить на участке</li><li>♻️ Измельчить в щепу</li><li>🚛 Подготовить к вывозу</li><li>✅ Измельчить и вывезти остатки</li></ul><p class="muted">Вариант согласовывается при оформлении заказа.</p></div></div></div></section>`;
}
...
export function servicePage(service) {
  ...
  const isChipping = service.slug === 'izmeldenie-vetok';
